      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">CatalogHub</span>
          </Link>
          ...
          <form onSubmit={handleSearch} className="hidden lg:flex items-center max-w-md mx-4">
            <div className="relative w-full">
              <input
                ...
                className="w-full px-4 py-2 pl-10 pr-4 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:bg-white transition-colors"
              />
